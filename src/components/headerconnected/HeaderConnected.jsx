    ...
    <header className="w-full bg-purple-800 sticky top-0 z-50 shadow-lg">
      <div className="max-w-7xl mx-auto px-6 sm:px-10 lg:px-16">
        <div className="flex items-center justify-between h-20">
          ...
          <div className="hidden lg:flex items-center gap-3 flex-shrink-0">
            ...
            {/* Bouton ajouter transaction rapide */}
            <Link
              to="/transactions"
              className="flex items-center gap-2 px-4 py-2 rounded-lg bg-white text-purple-800 text-sm font-bold hover:bg-purple-50 transition-all duration-200"
            >
              <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div className="relative" ref={profilRef}>
              <button
                ...
                className="flex items-center gap-2.5 px-3 py-2 rounded-lg hover:bg-purple-700 transition-all duration-200 border border-purple-600 hover:border-purple-500"
              >
              ...
              {/* Dropdown */}
              {profilOpen && (
                <div className="absolute right-0 top-full mt-2 w-60 bg-white rounded-2xl shadow-2xl border border-purple-100 overflow-hidden z-50">
      ...
      {menuOpen && (
        <div className="lg:hidden border-t border-purple-700 bg-purple-900 px-6 py-4 flex flex-col gap-2">
          ...
          {/* Bouton nouvelle transaction mobile */}
          <Link
            to="/transactions"
            onClick={() => setMenuOpen(false)}
            className="flex items-center gap-3 px-4 py-3 rounded-xl text-sm font-bold bg-white text-purple-800 hover:bg-purple-50 transition-all duration-200 mt-1"
          >
            <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 4v16m8-8H4" />
            </svg>
